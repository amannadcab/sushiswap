...
export class BabyDogeSwapProvider extends UniswapV2BaseProvider {
  constructor(chainId: ChainId, web3Client: PublicClient) {
    const factory = {
      ...
      [ChainId.BSC]: '0x4693B62E5fc9c0a45F89D62e6300a03C85f43137',
  ...
  getType(): LiquidityProviders {
    return LiquidityProviders.BabyDogeSwap
  }
